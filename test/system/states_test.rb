...
class StatesTest < ApplicationSystemTestCase
  ...
  test "creating a State" do
    ...
    fill_in "Max latitude", with: @state.max_latitude
    fill_in "Max longitude", with: @state.max_longitude
    fill_in "Min latitude", with: @state.min_latitude
    fill_in "Min longitude", with: @state.min_longitude
