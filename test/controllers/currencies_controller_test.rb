...
class CurrenciesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create currency" do
    assert_difference('Currency.count') do
      post currencies_url, params: { currency: { conversion_rate_to_usd: @currency.conversion_rate_to_usd, currency_name: @currency.currency_name, currency_symbol: @currency.currency_symbol } }
    end
  ...
  test "should update currency" do
    patch currency_url(@currency), params: { currency: { conversion_rate_to_usd: @currency.conversion_rate_to_usd, currency_name: @currency.currency_name, currency_symbol: @currency.currency_symbol } }
